            ...
            s = (function (e) {
              function t(t, o, n) {
                ...
                return (
                  ...
                  (a.backdropClasses =
                    null !== (s = null == d ? void 0 : d.backdropClasses) && void 0 !== s
                      ? s
                  ...
                  a.overlay &&
                    ((a.isCloseWhenClickInside =
                      (0, l.getClassProperty)(a.overlay, '--close-when-click-inside', 'false') ||
                      'false'),
                    (a.isTabAccessibilityLimited =
                      (0, l.getClassProperty)(a.overlay, '--tab-accessibility-limited', 'true') ||
                      'true'),
                    (a.hasAutofocus =
                      (0, l.getClassProperty)(a.overlay, '--has-autofocus', 'true') || 'true'),
              ...
              return (
                ...
                (t.accessibility = function (e) {
                  ...
                  var a = i && !e.metaKey
                  if (a && 'false' === i.element.isTabAccessibilityLimited && 'Tab' === e.code)
                    return !1
                  a && s.length && 'Tab' === e.code && (e.preventDefault(), this.onTab(i, s)),
                    a && 'Escape' === e.code && (e.preventDefault(), this.onEscape(i))
                }),
