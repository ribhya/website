...
<Tabs>
  <TabItem label="Solutions sur Mesure">
    Chaque projet de construction comporte ses propres défis et exigences. Chez Ribhya, nous personnalisons nos services pour correspondre à vos besoins spécifiques, garantissant que, quelle que soit l'échelle ou la complexité de votre projet, notre équipe est équipée pour le gérer avec précision et professionnalisme.
  </TabItem>
